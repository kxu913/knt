...
INSERT INTO `ny6design`.`t_shopping_rule` (`id`, `description`, `html`, `active`, `order`) VALUES ('1', '<strong>*Free Shipping!</strong>  On order over $50 for U.S. $75 for Canada (Regular Postal mail) .   $250 for International orders (up to $25 shipping discount credit for Regular Air mail).   <strong>Please add item to save on shipping!</strong>', 'checkout', '1', '1');
INSERT INTO `ny6design`.`t_shopping_rule` (`id`, `description`, `html`, `active`, `order`) VALUES ('2', '<strong>Domestic Express Mail pls Call 214-244-5851!</strong><br/>', 'checkout', '1', '2');
