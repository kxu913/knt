 ...
 * 
 */
public class ResetEmailThread implements Callable<Integer> {
	...
	public ResetEmailThread(EmailPropertiesFactory factory,
	...
	public Integer call() throws Exception {
		...
		notify.setSubject(factory.getValue("resetSubject"));
		notify.setToEmail(emailAddress);
		Map<String, Object> context = new HashMap<String, Object>();
		String link = factory.getValue("resetLink");
		context.put("link", refactorLink(link));
		notify.setTemplateName(factory.getValue("resetTemplate"));
